      ...
      points: [
        {
          ...
          text: 'Analytics & Intelligent Dunning',
          isAvailable: true,
        },
        {
          id: 2,
          icon: <IoIosCheckmarkCircle />,
          text: "Managed Sales Tax",
          isAvailable: true,
        },
        {
          id: 3,
          icon: <IoIosCloseCircle />,
          text: 'Hosted Sign-Up Pages & Open RESTful APIs',
          isAvailable: false,
        },
        {
          id: 4,
      ...
      <Container>
        ...
        <Flex sx={styles.buttonGroup}>
          <Box sx={styles.buttonGroupInner}>
            ...
            type="button" aria-label='Monthly' onClick={()=> handlePricingPlan('monthly')}> Monthly Plan</button>
          
          <button className={state.active === 'annual' ? 'active' : ''}
            type="button" aria-label='Annual' onClick={()=> handlePricingPlan('annual')}> Annual Plan</button>
